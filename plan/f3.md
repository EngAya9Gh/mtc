# تفاصيل شاشات Flutter - الجزء الثاني
# الفريزر + التوصيل + التبادل + التحويلات + الخدمات

---

## 10. شاشات Freezer Placement (وضع العينات في الفريزر)

### 10.1 FreezerOutBagsScanScreen (مسح الأكياس للخارج)
...
### 10.2 FreezerScanContainerBarcodeScreen (مسح باركود الحاوية)
...
### 10.3 FreezerScanBagBarcodeScreen (مسح باركود الكيس)
...
### 10.4 TaskDetailScreen (تفاصيل مهمة الفريزر)
...
## 11. شاشات التوصيل (Out-Freezer / Delivery Flow)

### 11.1 DeliveryTaskListScreen
**مثل TaskListScreen** ولكن يستدعي `driver/client/tasks` بدل `driver/tasks`

### 11.2 DeliveryLocationCheckScreen
...
### 11.4 DeliveryBagsScreen
**التصميم**: قائمة الأكياس الممسوحة + أزرار

### 11.5 DeliverySignatureScreen
...
## 12. شاشات التبادل (Swap Flow)

### 12.1 SwapTaskListScreen
...
### 12.3 SwapCompleteScreen
**التصميم**: رسالة نجاح + زر العودة للرئيسية

---

## 13. شاشات التحويلات المالية (Money Transfer Flow)

### 13.1 MoneyTransferListScreen
...
### 14.4 TaskStatusScreen
**التصميم**: أيقونة نجاح ✅ + رسالة "تمت العملية بنجاح" + زر العودة

---

## 15. الخدمات الخلفية (Background Services)

### 15.1 خدمة تتبع الموقع
```
الإعدادات:
├── interval: 30 ثانية
...
## 16. ملخص جميع حالات المهمة وتدفقاتها
...
## 17. بيانات مهمة يجب حفظها أثناء التنقل (UserInfo State)
